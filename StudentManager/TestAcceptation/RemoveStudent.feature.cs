...
#line 9
 testRunner.When(string.Format("I enter the command \"-f testDB -RemoveStudent --Class={0} -n Thibodeau -p Gustave\"", @class), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 10
