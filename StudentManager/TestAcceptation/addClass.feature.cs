...
#line hidden
        ...
        public virtual void AddAClass_GreenPath(string class1, string class2, string class3, string[] exampleTags)
        {
...
#line 8
 testRunner.Given(string.Format("I have one {0} in the data base", class1), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 9
